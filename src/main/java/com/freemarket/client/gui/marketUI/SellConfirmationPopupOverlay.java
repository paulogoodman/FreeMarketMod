...
public class SellConfirmationPopupOverlay extends PopupOverlay {
    ...
    private void renderQuantitySection(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        int sellAllX = sectionX + sectionWidth - buttonWidth - 6;
        boolean sellAllHovered = mouseX >= sellAllX && mouseX <= sellAllX + buttonWidth && mouseY >= buttonY && mouseY <= buttonY + buttonHeight;
        guiGraphics.fill(sellAllX, buttonY, sellAllX + buttonWidth, buttonY + buttonHeight, sellAllHovered ? 0xCC2196F3 : 0x992196F3);
        guiGraphics.drawString(minecraft.font, "Sell All", sellAllX + 20, buttonY + 6, TEXT_PRIMARY);
    ...
    private void renderSummary(GuiGraphics guiGraphics) {
        ...
        String totalText = "Total: $" + totalPayout;
    ...
    private void renderButtons(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(minecraft.font, "Confirm Sale", confirmX + 32, buttonY + 8, TEXT_PRIMARY);
    ...
    protected boolean handlePopupClick(double mouseX, double mouseY, int button) {
        ...
        int sellAllX = sectionX + sectionWidth - 90 - 6;
        if (mouseX >= sellAllX && mouseX <= sellAllX + 90 && mouseY >= buttonY && mouseY <= buttonY + 20) {
